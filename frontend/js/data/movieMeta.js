...
export const movieMeta = {
  ...
  "2001": { primaryGenre: "SCIFI", secondaryGenre: "MYSTERY", tone: "SERIOUS", year: 1968, franchise: ["Kubrick"] },
  dune_1984: { primaryGenre: "SCIFI", secondaryGenre: "ADVENTURE", tone: "EPIC", year: 1984, franchise: ["Dune"] },
  ...
  field_of_dreams: { primaryGenre: "DRAMA", secondaryGenre: "FANTASY", tone: "SERIOUS", year: 1989, franchise: null },
  do_the_right_thing: { primaryGenre: "DRAMA", secondaryGenre: "COMEDY", tone: "SERIOUS", year: 1989, franchise: null },
  ...
  mystery_train: { primaryGenre: "MYSTERY", secondaryGenre: "COMEDY", tone: "QUIRKY", year: 1989, franchise: ["Arthouse"] },
  wings_of_desire: { primaryGenre: "ROMANCE", secondaryGenre: "DRAMA", tone: "SERIOUS", year: 1987, franchise: ["Arthouse"] },
  mandy_2018: { primaryGenre: "HORROR", secondaryGenre: "ACTION", tone: "DARK", year: 2018, franchise: ["Arthouse"] },

  // Matinee expansion metadata
  wizard_of_oz: { primaryGenre: "FANTASY", secondaryGenre: "MUSICAL", tone: "QUIRKY", year: 1939, franchise: ["OZ"] },
  friday_the_13th: { primaryGenre: "HORROR", secondaryGenre: "THRILLER", tone: "DARK", year: 1980, franchise: ["Friday the 13th"] },
  airplane: { primaryGenre: "COMEDY", secondaryGenre: null, tone: "FUNNY", year: 1980, franchise: null },
  the_naked_gun: { primaryGenre: "COMEDY", secondaryGenre: "CRIME", tone: "FUNNY", year: 1988, franchise: ["Naked Gun"] },
  young_frankenstein: { primaryGenre: "COMEDY", secondaryGenre: "HORROR", tone: "FUNNY", year: 1974, franchise: null },
  superbad: { primaryGenre: "COMEDY", secondaryGenre: null, tone: "FUNNY", year: 2007, franchise: null },
  wedding_crashers: { primaryGenre: "COMEDY", secondaryGenre: "ROMANCE", tone: "FUNNY", year: 2005, franchise: null },
  the_hangover: { primaryGenre: "COMEDY", secondaryGenre: null, tone: "FUNNY", year: 2009, franchise: ["Hangover"] },
  the_40_year_old_virgin: { primaryGenre: "COMEDY", secondaryGenre: "ROMANCE", tone: "FUNNY", year: 2005, franchise: null },
  heat: { primaryGenre: "CRIME", secondaryGenre: "THRILLER", tone: "SERIOUS", year: 1995, franchise: null },
  pirates_black_pearl: { primaryGenre: "ADVENTURE", secondaryGenre: "FANTASY", tone: "EPIC", year: 2003, franchise: ["Pirates of the Caribbean"] },
  the_mummy_1999: { primaryGenre: "ADVENTURE", secondaryGenre: "ACTION", tone: "EPIC", year: 1999, franchise: ["Mummy"] },
  chicago: { primaryGenre: "MUSICAL", secondaryGenre: "DRAMA", tone: "EPIC", year: 2002, franchise: null },
  inglourious_basterds: { primaryGenre: "DRAMA", secondaryGenre: "ACTION", tone: "DARK", year: 2009, franchise: ["QT"] },
  there_will_be_blood: { primaryGenre: "DRAMA", secondaryGenre: null, tone: "SERIOUS", year: 2007, franchise: ["PTA"] },
  boogie_nights: { primaryGenre: "DRAMA", secondaryGenre: "COMEDY", tone: "QUIRKY", year: 1997, franchise: ["PTA"] },
  magnolia: { primaryGenre: "DRAMA", secondaryGenre: null, tone: "SERIOUS", year: 1999, franchise: ["PTA"] },
  mulholland_drive: { primaryGenre: "MYSTERY", secondaryGenre: "DRAMA", tone: "DARK", year: 2001, franchise: ["Lynch"] },
  eraserhead: { primaryGenre: "HORROR", secondaryGenre: "MYSTERY", tone: "DARK", year: 1977, franchise: ["Lynch"] },
  the_nice_guys: { primaryGenre: "COMEDY", secondaryGenre: "CRIME", tone: "QUIRKY", year: 2016, franchise: null },
  iron_man: { primaryGenre: "ACTION", secondaryGenre: "SCIFI", tone: "EPIC", year: 2008, franchise: ["MCU"] },
  el_mariachi: { primaryGenre: "ACTION", secondaryGenre: "CRIME", tone: "QUIRKY", year: 1992, franchise: ["El Mariachi"] },
  from_dusk_till_dawn: { primaryGenre: "HORROR", secondaryGenre: "ACTION", tone: "DARK", year: 1996, franchise: ["QT"] },
  sin_city_2005: { primaryGenre: "CRIME", secondaryGenre: "THRILLER", tone: "DARK", year: 2005, franchise: ["Sin City"] },
  evil_dead_2: { primaryGenre: "HORROR", secondaryGenre: "COMEDY", tone: "DARK", year: 1987, franchise: ["Evil Dead"] },
  escape_from_new_york: { primaryGenre: "ACTION", secondaryGenre: "SCIFI", tone: "DARK", year: 1981, franchise: ["Carpenter"] },
  christine: { primaryGenre: "HORROR", secondaryGenre: null, tone: "DARK", year: 1983, franchise: ["Carpenter"] },
  bad_boys: { primaryGenre: "ACTION", secondaryGenre: "COMEDY", tone: "QUIRKY", year: 1995, franchise: ["Bad Boys"] },
  monsters_inc: { primaryGenre: "ANIMATION", secondaryGenre: "COMEDY", tone: "FUNNY", year: 2001, franchise: ["Pixar"] },
  coraline: { primaryGenre: "ANIMATION", secondaryGenre: "FANTASY", tone: "DARK", year: 2009, franchise: null },
  paranorman: { primaryGenre: "ANIMATION", secondaryGenre: "HORROR", tone: "QUIRKY", year: 2012, franchise: null },
  my_neighbor_totoro: { primaryGenre: "ANIMATION", secondaryGenre: "FANTASY", tone: "QUIRKY", year: 1988, franchise: ["Ghibli"] },
  ace_ventura_pet_detective: { primaryGenre: "COMEDY", secondaryGenre: null, tone: "FUNNY", year: 1994, franchise: ["Carrey"] },
  batman_forever: { primaryGenre: "ACTION", secondaryGenre: "SCIFI", tone: "QUIRKY", year: 1995, franchise: ["Batman", "DC"] },
  the_wiz: { primaryGenre: "MUSICAL", secondaryGenre: "FANTASY", tone: "QUIRKY", year: 1978, franchise: ["OZ"] },
  paprika: { primaryGenre: "ANIMATION", secondaryGenre: "SCIFI", tone: "QUIRKY", year: 2006, franchise: null },
  titanic: { primaryGenre: "DRAMA", secondaryGenre: "ROMANCE", tone: "SERIOUS", year: 1997, franchise: ["Cameron"] },
  monty_python_holy_grail: { primaryGenre: "COMEDY", secondaryGenre: "FANTASY", tone: "QUIRKY", year: 1975, franchise: null },
  sound_of_music: { primaryGenre: "MUSICAL", secondaryGenre: "DRAMA", tone: "EPIC", year: 1965, franchise: null },
  superman_1978: { primaryGenre: "ACTION", secondaryGenre: "SCIFI", tone: "EPIC", year: 1978, franchise: ["Superman", "DC"] },
  harry_potter_chamber: { primaryGenre: "FANTASY", secondaryGenre: "ADVENTURE", tone: "QUIRKY", year: 2002, franchise: ["Harry Potter"] },
  harry_potter_azkaban: { primaryGenre: "FANTASY", secondaryGenre: "ADVENTURE", tone: "DARK", year: 2004, franchise: ["Harry Potter"] },
  the_thing: { primaryGenre: "HORROR", secondaryGenre: "SCIFI", tone: "DARK", year: 1982, franchise: ["Carpenter"] },
  aliens: { primaryGenre: "SCIFI", secondaryGenre: "HORROR", tone: "EPIC", year: 1986, franchise: ["Alien", "Cameron"] },
  the_master: { primaryGenre: "DRAMA", secondaryGenre: null, tone: "SERIOUS", year: 2012, franchise: ["PTA"] },
  blue_velvet: { primaryGenre: "MYSTERY", secondaryGenre: "DRAMA", tone: "DARK", year: 1986, franchise: ["Lynch"] },
  iron_man_3: { primaryGenre: "ACTION", secondaryGenre: "SCIFI", tone: "EPIC", year: 2013, franchise: ["MCU"] },
  lethal_weapon_2: { primaryGenre: "ACTION", secondaryGenre: "COMEDY", tone: "QUIRKY", year: 1989, franchise: ["Lethal Weapon"] },
  drag_me_to_hell: { primaryGenre: "HORROR", secondaryGenre: "COMEDY", tone: "DARK", year: 2009, franchise: null },
  doctor_strange_multiverse_madness: { primaryGenre: "ACTION", secondaryGenre: "FANTASY", tone: "EPIC", year: 2022, franchise: ["MCU"] },
  transformers: { primaryGenre: "ACTION", secondaryGenre: "SCIFI", tone: "EPIC", year: 2007, franchise: ["Transformers"] },
  cars_2: { primaryGenre: "ANIMATION", secondaryGenre: "COMEDY", tone: "FUNNY", year: 2011, franchise: ["Pixar"] },
  nausicaa_valley_wind: { primaryGenre: "ANIMATION", secondaryGenre: "FANTASY", tone: "EPIC", year: 1984, franchise: ["Ghibli"] },
  beavis_and_butthead_do_america: { primaryGenre: "COMEDY", secondaryGenre: null, tone: "FUNNY", year: 1996, franchise: ["Beavis and Butt-Head"] },
  idiocracy: { primaryGenre: "COMEDY", secondaryGenre: "SCIFI", tone: "QUIRKY", year: 2006, franchise: ["JUDGE"] },
  extract: { primaryGenre: "COMEDY", secondaryGenre: null, tone: "QUIRKY", year: 2009, franchise: ["JUDGE"] },
  the_mask: { primaryGenre: "COMEDY", secondaryGenre: "FANTASY", tone: "FUNNY", year: 1994, franchise: ["Carrey"] },
  dumb_and_dumber: { primaryGenre: "COMEDY", secondaryGenre: null, tone: "FUNNY", year: 1994, franchise: ["Carrey"] },
  prince_of_darkness: { primaryGenre: "HORROR", secondaryGenre: null, tone: "DARK", year: 1987, franchise: ["Carpenter"] }
};
